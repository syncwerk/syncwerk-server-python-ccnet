...
from pyrpcsyncwerk import rpcsyncwerk_server
...
def register_rpc_functions(session):
    ...
    rpcsyncwerk_server.create_service(RPC_SERVICE_NAME)
    rpcsyncwerk_server.register_function(RPC_SERVICE_NAME, str_mul)
